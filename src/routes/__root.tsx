...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://case-resolve-fast.vercel.app/favicon.svg?v=bankxio" },
      { name: "twitter:image", content: "https://case-resolve-fast.vercel.app/favicon.svg?v=bankxio" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "icon", href: "/favicon.svg?v=bankxio", type: "image/svg+xml" },
      { rel: "shortcut icon", href: "/favicon.ico?v=bankxio", type: "image/x-icon" },
