...
import { FundingAnnouncement } from "@/components/site/FundingAnnouncement";
    ...
    <section id="bankxio-home" className="relative overflow-hidden scroll-mt-[68px]">
      ...
      <div className="relative max-w-[1200px] mx-auto px-6 pt-16 pb-24 grid lg:grid-cols-[1.05fr_1fr] gap-14 items-center">
        <div>
          ...
          <h1
            className="mt-6 text-[44px] md:text-[56px] lg:text-[60px] leading-[1.02] font-light text-[color:var(--color-ink)]"
          ...
          <p className="mt-6 text-[17px] leading-[1.5] text-[color:var(--color-ink-secondary)] max-w-xl">
            Bankxio controls the operational journey after an exception, alert, dispute or complaint
            is created — across the systems fintechs, neobanks, lenders and payment institutions
            already use.
          </p>
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <a href="#platform-tour" className="btn-pill btn-secondary">
              <Play className="w-3.5 h-3.5" /> Watch Platform Tour
            </a>
          </div>
          <div className="mt-10 flex flex-wrap items-center gap-6 text-[13px] text-[color:var(--color-ink-mute)]">
            <div className="flex items-center gap-2">
              <Check className="w-3.5 h-3.5 text-[color:var(--color-brand-primary)]" /> Role-based
              controls
            </div>
            <div className="flex items-center gap-2">
              <Check className="w-3.5 h-3.5 text-[color:var(--color-brand-primary)]" />{" "}
              Maker-checker decisions
            </div>
            <div className="flex items-center gap-2">
              <Check className="w-3.5 h-3.5 text-[color:var(--color-brand-primary)]" /> Audit-ready
              history
            </div>
          </div>
        </div>
  ...
  const cards = [
    {
      ...
      badge: "Manual Review",
      tone: "indigo",
      body: "Customer verification requests managed manually across multiple disconnected systems.",
    },
    {
      icon: AlertTriangle,
      ...
      badge: "High Priority",
      tone: "ruby",
      body: "Fraud and AML alerts reviewed using disconnected tools and spreadsheets.",
    },
    {
      icon: MessageSquare,
      ...
      badge: "Pending",
      tone: "magenta",
      body: "Evidence, communication and decisions scattered across emails and internal notes.",
    },
    {
      icon: Timer,
      title: "SLA Tracking",
      badge: "At Risk",
      tone: "amber",
      body: "Response deadlines monitored manually, increasing operational risk.",
    },
  ] as const;
      ...
      <div className="max-w-[1200px] mx-auto px-6 grid lg:grid-cols-[0.9fr_1.1fr] gap-14 items-start">
        <div className="lg:sticky lg:top-28">
          ...
          <p className="mt-5 text-[16px] leading-[1.55] text-[color:var(--color-ink-mute)] max-w-md">
            A single customer case often requires information from compliance, fraud, customer
            support, payments and core banking systems. Teams waste valuable time navigating
            disconnected workflows instead of resolving issues.
          </p>
        </div>
        <div className="grid sm:grid-cols-2 gap-5">
          {cards.map((c) => (
            <div key={c.title} className="card-base p-6 hover-lift group cursor-pointer">
              <div
                className={`w-9 h-9 rounded-lg flex items-center justify-center ${toneMap[c.tone]}`}
              >
                <c.icon className="w-4 h-4" />
              </div>
              <div className="mt-5 flex items-center justify-between">
                <h3 className="text-[17px] font-normal text-[color:var(--color-ink)]">{c.title}</h3>
                <span className={`text-[10px] px-2 py-0.5 rounded-full ${toneMap[c.tone]}`}>
                  {c.badge}
                </span>
              </div>
              <p className="mt-2 text-[14px] leading-[1.55] text-[color:var(--color-ink-mute)]">
                {c.body}
              </p>
      ...
      <div className="max-w-[1200px] mx-auto px-6 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          <p className="mt-5 text-[16px] leading-[1.55] text-[color:var(--color-ink-mute)] max-w-lg">
            Bankxio accepts exceptions and alerts from your existing stack, then controls the human
            workflow that follows — ownership, evidence, decisions, deadlines and audit history.
          </p>
          <ul className="mt-6 space-y-3">
            {[
              ...
              <li
                key={f}
                className="flex items-center gap-3 text-[15px] text-[color:var(--color-ink)]"
              >
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="max-w-3xl mb-12">
          ...
          <p className="mt-5 text-[16px] leading-[1.55] text-[color:var(--color-ink-mute)]">
            Monitor active investigations, workload, AI summaries and SLA performance from a single
            command centre designed for modern fintech operations.
          </p>
        </div>
        <DashboardMockup />
      </div>
    ...
    <section className="py-24 bg-white">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center mb-4">
          ...
          <p className="mt-5 text-[16px] leading-[1.55] text-[color:var(--color-ink-mute)]">
            Bankxio works alongside your existing financial systems so your teams never need to
  ...
  const useCases = [
    {
      icon: IdCard,
      title: "KYC exceptions",
      body: "Turn verification exceptions into assigned, evidence-linked review work.",
      href: "/solutions/kyc-exceptions",
    },
    {
      icon: AlertTriangle,
      title: "Transaction alerts",
      body: "Move from detection signal to a controlled human disposition.",
      href: "/solutions/transaction-alerts",
    },
    {
      icon: Scale,
      title: "Disputes & complaints",
      body: "Keep evidence, customer communication and deadlines in one case.",
      href: "/solutions/disputes-complaints",
    },
    {
      icon: CreditCard,
      title: "Payment institutions",
      body: "Coordinate compliance, fraud and support around payment exceptions.",
      href: "/solutions/payment-institutions",
    },
    {
      icon: TimerReset,
      title: "SLA operations",
      body: "Make deadlines, escalations and performance explainable at case level.",
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-[16px] leading-[1.6] text-[color:var(--color-ink-mute-2)] max-w-2xl">
            Each demo scenario shows how Bankxio connects the trigger, evidence, owner, deadline and
            resolution without replacing source systems.
          </p>
        </div>
        <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {useCases.map((useCase, index) => (
            ...
            >
              ...
              <p className="mt-2 text-[14px] leading-[1.6] text-[color:var(--color-ink-mute-2)] max-w-lg">
                {useCase.body}
              </p>
            </a>
          ))}
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {cards.map((card) => (
            <Link
              key={card.title}
              to={card.to}
              className="rounded-xl border border-[color:var(--color-hairline)] p-7 hover-lift group"
            >
              <card.icon className="w-5 h-5 text-[color:var(--color-brand-primary)]" />
              <div className="mt-6 text-[10px] uppercase tracking-[0.1em] text-[color:var(--color-brand-primary-deep)]">
                {card.eyebrow}
              </div>
              <h3 className="mt-3 text-[22px] leading-[1.25] font-light text-[color:var(--color-ink)]">
                {card.title}
              </h3>
              <p className="mt-3 text-[13px] leading-[1.6] text-[color:var(--color-ink-mute-2)]">
                {card.body}
              </p>
...
function Benefits() {
  ...
  return (
    <section className="py-24 bg-[color:var(--color-canvas-cream)]">
      <div className="max-w-[1200px] mx-auto px-6">
        <h2
          className="text-[36px] md:text-[44px] leading-[1.08] font-light text-[color:var(--color-ink)] mb-12"
          style={{ letterSpacing: "-1px" }}
        >
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {items.map((it, i) => (
            <div
              key={it}
              className="bg-white/70 backdrop-blur border border-[#e8dcc3] rounded-xl p-7 hover-lift"
            >
              <div className="text-[11px] tnum text-[color:var(--color-ink-mute)]">0{i + 1}</div>
              <p
                className="mt-3 text-[19px] font-light leading-[1.35] text-[color:var(--color-ink)]"
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {tiers.map((t) => {
            ...
            return (
              <div
                key={t.name}
                className={`relative rounded-xl border p-8 flex flex-col hover-lift ${dark ? "bg-[color:var(--color-brand-dark-900)] text-white border-transparent" : "bg-white border-[color:var(--color-hairline)]"}`}
              >
                {t.badge && (
                  <span className="absolute -top-3 left-8 text-[10px] uppercase tracking-[0.1em] bg-[color:var(--color-brand-primary)] text-white px-3 py-1 rounded-full">
                    {t.badge}
                  </span>
                )}
                <div className="text-[22px] font-light" style={{ letterSpacing: "-0.3px" }}>
                  {t.name}
                </div>
                <p
                  className={`mt-2 text-[14px] leading-[1.5] ${dark ? "text-white/70" : "text-[color:var(--color-ink-mute)]"}`}
                >
                  {t.desc}
                </p>
                <div className="mt-6 flex items-baseline gap-2">
                  <span className="text-[36px] font-light tnum" style={{ letterSpacing: "-1px" }}>
                    {t.price}
                  </span>
                  <span
                    className={`text-[13px] ${dark ? "text-white/60" : "text-[color:var(--color-ink-mute)]"}`}
                  >
                    {t.cadence}
                  </span>
                </div>
                <ul className="mt-6 space-y-2.5 flex-1">
                  {t.features.map((f) => (
                    <li
                      key={f}
                      className={`flex items-center gap-2 text-[14px] ${dark ? "text-white/90" : "text-[color:var(--color-ink)]"}`}
                    >
                      <Check
                        className={`w-4 h-4 ${dark ? "text-[#665efd]" : "text-[color:var(--color-brand-primary)]"}`}
                      />{" "}
                      {f}
                    </li>
                  ))}
                ...
                <Link
                  to={t.to}
                  className={`btn-pill mt-8 w-full justify-center ${dark ? "btn-on-dark" : "btn-primary"}`}
                >
                  {t.cta}
                </Link>
              </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((s) => (
          <div key={s.label} className="card-base p-8 hover-lift">
            <div
              className="text-[46px] font-light text-[color:var(--color-ink)]"
  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-[900px] mx-auto px-6 text-center">
        <div className="text-[11px] uppercase tracking-[0.12em] text-[color:var(--color-brand-primary-deep)] mb-6">
          Testimonial
        </div>
        <blockquote
          className="text-[28px] md:text-[34px] font-light leading-[1.35] text-[color:var(--color-ink)]"
          style={{ letterSpacing: "-0.6px" }}
        >
          &ldquo;Bankxio transformed how our operations team manages compliance cases.
          Investigations that previously required multiple systems are now completed from one
          unified workspace, significantly reducing response times.&rdquo;
        </blockquote>
        <div className="mt-8 flex items-center justify-center gap-3">
          <div
            className="w-11 h-11 rounded-full flex items-center justify-center text-white font-light"
          ...
          <div className="text-left">
            ...
            <div className="text-[13px] text-[color:var(--color-ink-mute)]">
...
function FAQ() {
  const faqs = [
    {
      q: "What types of cases can Bankxio manage?",
      a: "Bankxio supports KYC exceptions, transaction alerts, customer disputes, complaints, fraud investigations and operational compliance workflows.",
    },
    {
      q: "Does Bankxio integrate with existing banking systems?",
      a: "Yes. Bankxio connects with core banking platforms, KYC providers, AML systems, CRMs, customer support platforms and payment processors.",
    },
    {
      q: "How do AI summaries work?",
      a: "Bankxio automatically generates concise summaries from case activity while maintaining complete audit history.",
    },
    {
      q: "Can SLA rules be customised?",
      a: "Yes. Teams can define response targets, escalation rules and priority levels.",
    },
  ];
  return (
    <section className="py-24 bg-[color:var(--color-canvas-soft)]">
      <div className="max-w-[820px] mx-auto px-6">
        <h2
          className="text-[36px] md:text-[42px] font-light text-[color:var(--color-ink)] mb-10"
          style={{ letterSpacing: "-1px" }}
        >
        ...
        <div className="divide-y divide-[color:var(--color-hairline)] border-y border-[color:var(--color-hairline)] bg-white rounded-xl">
          {faqs.map((f) => (
            <details key={f.q} className="group px-6 py-5">
              ...
              <p className="mt-3 text-[15px] leading-[1.6] text-[color:var(--color-ink-mute)]">
                {f.a}
              </p>
            </details>
          ))}
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-[color:var(--color-brand-dark-900)] text-white">
      <div
        ...
        style={{
          background:
            "radial-gradient(60% 100% at 20% 0%, #533afd 0%, transparent 60%), radial-gradient(60% 100% at 90% 100%, #ea2261 0%, transparent 60%)",
        }}
      />
      <div className="relative max-w-[900px] mx-auto px-6 text-center">
        ...
        <p className="mt-5 text-[17px] text-white/70 max-w-2xl mx-auto">
          See how Bankxio helps operations teams resolve compliance cases faster with intelligent
          workflows, AI summaries and real-time SLA management.
        </p>
        <div className="mt-8 flex justify-center gap-3">
          <Link to="/request-demo" className="btn-pill btn-on-dark">
            Request Demo
          </Link>
        </div>
      </div>
